...
RUN_DEMO_ARGS := --symbol $(SYMBOL) --max-ticks $(MAX_TICKS) --log-level $(LOG_LEVEL) $(EXTRA)
...
help:
	...
	@echo "  make demo SYMBOL=ETHUSDT   # run demo grid loop (MAX_TICKS=0 means infinite)"
	...
	@echo "  SYMBOL=..., MAX_TICKS=..., LOG_LEVEL=..., EXTRA='...'"
